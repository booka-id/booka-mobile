...
class _BookDetailPageState extends State<BookDetailsPage> {
  ...
  Future<void> submitOrder(int userId, int quantity, String paymentMethod) async {
    final url = Uri.parse('https://deploytest-production-cf18.up.railway.app/catalogue/buy-book-flutter/'); // Ganti dengan URL API yang sesuai
  ...
  final url = Uri.parse('https://deploytest-production-cf18.up.railway.app/catalogue/delete-book-flutter/$bookId/'); // Sesuaikan dengan URL API Anda
